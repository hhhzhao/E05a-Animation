...
import arcade
#set the width and height for the arcade
SCREEN_WIDTH = 640
SCREEN_HEIGHT = 480
#add title to the screen
SCREEN_TITLE = "Move Mouse Example"

#set a class for the red ball
class Ball:
...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if button == arcade.MOUSE_BUTTON_LEFT:
            #change the color of the ball to black after click the left button of the mouse
    ...
    def on_mouse_release(self, x, y, button, modifiers):
        ...
        """
        if button == arcade.MOUSE_BUTTON_LEFT:
            #after release the button, the color goes back
            self.ball.color = arcade.color.AUBURN


def main():
    #call the class and give the game width, height, and the title of the screen
